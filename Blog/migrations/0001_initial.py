# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-06-03 18:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modifield_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
                ('status', models.CharField(choices=[('d', 'Draft'), ('p', 'Published')], max_length=1, verbose_name='文章状态')),
                ('abstract', models.CharField(blank=True, help_text='可选,如若为空将摘取正文的前60个字符', max_length=60, null=True, verbose_name='摘要')),
